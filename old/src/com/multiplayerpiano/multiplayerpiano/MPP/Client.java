...
public class Client extends EventEmitter {
    ...
    public void connect(){
        ...
        headers.put("Sec-WebSocket-Origin", "http://www.multiplayerpiano.com");
        this.ws = new WebSocketClient(uri, new Draft_10(), headers, 0) {
            @Override
    ...
    private Runnable sendPings = new Runnable() {
    ...
    private Runnable sendNotes = new Runnable() {
        @Override public void run() {
